# نظام محاسبة ويب (Flask + Arabic RTL)

هيكل أولي لتطبيق محاسبي متكامل باللغة العربية باستخدام Python و Flask، مع واجهة تدعم اتجاه الكتابة من اليمين إلى اليسار (RTL).
